...
Class FCKeditor
	...
	Public Function CreateHtml_Template( instanceName, style )
		dim html
		...
		If IsCompatible() Then
			...
			' Render the editor IFRAME.
			html = html & "<iframe id=""" & instanceName & "___Frame"" src=""" & sLink & """ style=""" & style & """ frameborder=""0"" scrolling=""no""></iframe>"

		Else


			html = "<textarea name=""" & instanceName & """ rows=""4"" cols=""40"" style=""" & style & """>" & Server.HTMLEncode( sValue ) & "</textarea>"

		End If

		CreateHtml_Template = html
