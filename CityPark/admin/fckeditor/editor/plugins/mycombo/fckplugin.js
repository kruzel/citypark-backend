...
FCKToolbarMyCombo.prototype.CreateItems=function(A){
	...
	this._Combo.AddItem('[news]', 'חדשות רצות');
	this._Combo.AddItem('[hebrewdate]', 'תאריך עברי');
	this._Combo.AddItem('[menu]', 'תפריט 1');

}

//Register the combo with the FCKEditor
FCKToolbarItems.RegisterItem( 'mycombo'	, new FCKToolbarMyCombo( 'בלוקים', FCK_TOOLBARITEM_ICONTEXT ) ) ; //or FCK_TOOLBARITEM_ONLYTEXT
