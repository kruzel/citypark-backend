	    ...
	    Select Case Request.QueryString("action")
	       Case "edit"
	       	 Editmode= "True"
				    ...
				    Sql = "SELECT ContentButtom, SiteID FROM Site WHERE SiteID=" & Request.QueryString("ID")
			            Set objRs = OpenDB(sql)
        					objRs("ContentButtom") = Request.Form("ContentButtom")
                        		objRs.Update
								objRs.Close
...
<form action="admin_footer.asp?mode=doit<% If Editmode="True" Then %>&ID=<% = objRs("SiteID")%><% ENd IF %>&action=<%=Request.Querystring("action") %>" method="post" id="block2" name="block2" class="_validate">
			<div class="incontentboxgrid2">
				...
				<% ELSE 
				%>
					<h1>עריכת תוכן בחלק התחתון (Footer)</h1>
				<% End If %>
				</div>
			    <div class="rightform">
				<table class="tableform" dir="rtl" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                <td width="20%" align="right">תוכן חלק תחתון</td>
				</tr>
				<tr>
				<td align="right">
						<% Dim oFCKeditor
	                        ...
	                        oFCKeditor.BasePath = "FCKeditor/"
	                            If Editmode = "True" Then
		                            oFCKeditor.Value=objRs("ContentButtom")
	                            End If
	                                ...
	                                oFCKeditor.height="370px"
	                                    ...
	                                    End If
	                                oFCKeditor.Create "ContentButtom" %>
						</td>
					</tr>
			</table>
				</div>
