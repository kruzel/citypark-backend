...
<script type="text/javascript" src="<% = SiteLayout %>gallery9/highslide/highslide-with-gallery.js"></script>
<link rel="stylesheet" type="text/css" href="<% = SiteLayout %>gallery9/highslide/highslide.css" />
<% else %>
<script type="text/javascript" src="/blocks/gallery9/highslide/highslide-with-gallery.js"></script>
<link rel="stylesheet" type="text/css" href="/blocks/gallery9/highslide/highslide.css" />
<% End If %>
