...
function getScore(form) {  
	...
	var zmanMesuarHanayaMyadit = (2+(1.48*1*(answers[1]*answers[4])));

	var HistabrutHanaya=Math.abs(1-(answers[1]*answers[4]))

	var SetachHanaya=(answers[3])

	var alutDelek=(6.35*0.25*zmanMesuarHanayaMyadit/9.5)

	var alutBluy = zmanMesuarHanayaMyadit * 0.25 *2.016;

	var alutHanayaTosavHoutzTime=answers[0]*answers[5];

	var alutKolelet=(alutDelek+alutBluy+alutHanayaTosavHoutzTime)

	var histabrutKnas=answers[5]/answers[6];

	var zihumAvir=0.25*answers[2]*answers[5];

	var alutHanayaKnas=(answers[5]*60)/100;

        var HefreshHanayot=answers[0]*answers[5]*(answers[4]*answers[1]+1);

	

       correctAnswers+="עלות כוללת לחניה ברחוב" + alutKolelet+ "\r\n";

       correctAnswers+="עלות צריכת דלק עד למציאת חניה " + alutDelek+ "\r\n";

       correctAnswers+="עלות אחזקת רכב עד למציאת חניה " + alutBluy+ "\r\n";

       correctAnswers+="עלות חניה ברחוב לתושב חוץ" + alutHanayaTosavHoutzTime+ "\r\n";

       correctAnswers+="עלות החניה - במקרה של קנס" + alutHanayaKnas+ "\r\n";

       correctAnswers+="זמן משוער למציאת חניה ברחוב בסיבוב אחד" + zmanMesuarHanayaMyadit+ "\r\n";

       correctAnswers+="הסתברות למציאת חניה מיידית ברחוב " + HistabrutHanaya+ "\r\n";

       correctAnswers+="הסתברות לקנס ברחוב לרכב ללא תו אזורי" + histabrutKnas+ "\r\n";
...
<h3 class="sim_h1">בחר עיר</h3>
  ...
  <li><input type="radio" name="q1" value="5.2">תל אביב-יפו</li>
...
<h3 class="sim_h2">בחר אזור בעיר</h3>
  ...
  <li><input type="radio" name="q2" value="0.9">מרכז</li>
...
<h3 class="sim_h3">בחר קבוצת רישוי</h3>
  ...
  <li><input type="radio" name="q3" value="169.583">קבוצה 3</li>
...
<h3 class="sim_h4">בחר סוג רכב</h3>
  ...
  <li><input type="radio" name="q4" value="4.4">משפחתי</li>
...
<h3 class="sim_h5">בחר שעת חניה</h3>
  ...
  <li><input type="radio" name="q5" value="0.85">בוקר</li>
...
<h3 class="sim_h6">בחר זמן חניה משוער בדקות</h3>
  ...
  <li><input type="radio" name="q6" value="0.5">30 דקות</li>
...
<p> Parking Cost = <strong><input class="bgclr" type="text" size="5" name="percentage" READONLY></strong><br><br>
