    ...
    function toggle(object_name) {
        if (document.getElementById(object_name).style.display == "none") {
            if (navigator.appName == "Microsoft Internet Explorer") {
                ...
                document.getElementById(object_name).style.display = "table-row";
            }
        } else if (document.getElementById(object_name).style.display == "table-row" | document.getElementById(object_name).style.display == "block") {
...
Text2Send = Text2Send &  Trim(Request.Form("Name")) & vbcrlf & vbcrlf
...
Text2Send = Text2Send & Request.Form("Message")& vbcrlf & vbcrlf
	If SendMail(Request.Form("Name") & " " & "שלח לך קישור", "dont_replay@" & LCase(Request.ServerVariables("HTTP_HOST")), Request.Form("eMail"), Text2Send) = True Then
