...
function SniffLanguage(l)
{
	...
	AddValue(l, window.navigator.language);
	if(window.navigator.language.indexOf("-") != -1) 
		AddValue(l, window.navigator.language.substr(0, window.navigator.language.indexOf("-")));
}
function LoadNextLanguage()
{
	_xmlIndex ++;
	if(_xmlIndex == _xmlDocs.length) return;
	try
	{
		_xml.load("../localization/" + _xmlDocs[_xmlIndex] + ".xml");
	}
	catch(e)
	{
		LoadNextLanguage();
...
function LoadLanguage()
{
	...
	if(GetQuery("LanguageDetection") == "true" || GetQuery("LanguageDetection") == "")
	{
		SniffLanguage(_xmlDocs);
	}
	
	if(GetQuery("DefaultLanguage") != "")
	{
		AddValue(_xmlDocs, GetQuery("DefaultLanguage"));
	}
	else
	{
		AddValue(_xmlDocs, "en-us");
	}
	...
	if(document.implementation)
		if(document.implementation.createDocument)
		{
			...
			_xml.onload = AssignLanguage;
			LoadNextLanguage();
		}
}
function AssignLanguage()
{
	SetCookie("lang", _xmlDocs[_xmlIndex]);

	document.title = _xml.getElementsByTagName("Title")[0].firstChild.nodeValue;
	msg.BadNumber = _xml.getElementsByTagName("BadNumber")[0].firstChild.nodeValue;
	msg.Title = _xml.getElementsByTagName("Title")[0].firstChild.nodeValue;
	msg.SelectAColor = _xml.getElementsByTagName("SelectAColor")[0].firstChild.nodeValue;
	msg.OKButton = _xml.getElementsByTagName("OK")[0].firstChild.nodeValue;
	msg.CancelButton = _xml.getElementsByTagName("Cancel")[0].firstChild.nodeValue;
	msg.AboutButton = _xml.getElementsByTagName("About")[1].firstChild.nodeValue;
	msg.Recent = _xml.getElementsByTagName("Recent")[0].firstChild.nodeValue;
	msg.WebSafeWarning = _xml.getElementsByTagName("Image")[0].attributes["tooltip"].nodeValue;
	msg.WebSafeClick = _xml.getElementsByTagName("Color")[0].attributes["tooltip"].nodeValue;
	msg.HsbHue = _xml.getElementsByTagName("Hue")[0].firstChild.nodeValue;
	msg.HsbHueTooltip = _xml.getElementsByTagName("Hue")[0].attributes["tooltip"].nodeValue;
	msg.HsbHueUnit = _xml.getElementsByTagName("Hue")[0].attributes["measurement"].nodeValue;
	msg.HsbSaturation = _xml.getElementsByTagName("Saturation")[0].firstChild.nodeValue;
	msg.HsbSaturationTooltip = _xml.getElementsByTagName("Saturation")[0].attributes["tooltip"].nodeValue;
	msg.HsbSaturationUnit = _xml.getElementsByTagName("Saturation")[0].attributes["measurement"].nodeValue;
	msg.HsbBrightness = _xml.getElementsByTagName("Brightness")[0].firstChild.nodeValue;
	msg.HsbBrightnessTooltip = _xml.getElementsByTagName("Brightness")[0].attributes["tooltip"].nodeValue;
	msg.HsbBrightnessUnit = _xml.getElementsByTagName("Brightness")[0].attributes["measurement"].nodeValue;
	msg.RgbRed = _xml.getElementsByTagName("Red")[0].firstChild.nodeValue;
	msg.RgbRedTooltip = _xml.getElementsByTagName("Red")[0].attributes["tooltip"].nodeValue;
	msg.RgbGreen = _xml.getElementsByTagName("Green")[0].firstChild.nodeValue;
	msg.RgbGreenTooltip = _xml.getElementsByTagName("Green")[0].attributes["tooltip"].nodeValue;
	msg.RgbBlue = _xml.getElementsByTagName("Blue")[0].firstChild.nodeValue;
	msg.RgbBlueTooltip = _xml.getElementsByTagName("Blue")[0].attributes["tooltip"].nodeValue;
	msg.Hex = _xml.getElementsByTagName("Hex")[0].firstChild.nodeValue;
	msg.RecentTooltip = _xml.getElementsByTagName("RGB")[0].attributes["tooltip"].nodeValue;
	msg.About = _xml.getElementsByTagName("About")[0].firstChild.nodeValue;
}
function localize()
{
	SetHTML(
...
{
	if(confirm(msg.About)) window.open("http://www.lewismoten.com", "_blank");
}
...
function ColorMode_Changed(e)
{
	...
	{
		case 0:
			document.getElementById("imgGradient").src = "ColorSpace1.png";
			Show(
				document.getElementById("pnlGradientHsbHue_Hue"),
				document.getElementById("pnlGradientHsbHue_Black"),
				document.getElementById("pnlGradientHsbHue_White"),
			...
			break;
		case 1:
			document.getElementById("imgGradient").src = "ColorSpace2.png";
			document.getElementById("pnlVerticalHsbSaturation_Hue").src = "Vertical1.png";
			Show(
				document.getElementById("pnlGradientHsbHue_Hue"),
				document.getElementById("pnlVerticalHsbSaturation_Hue")
			);
		...
		case 2:
			document.getElementById("imgGradient").src = "ColorSpace2.png";
			document.getElementById("pnlVerticalHsbSaturation_Hue").src = "Vertical2.png";
			Show(
				document.getElementById("pnlGradientHsbHue_Hue"),
				document.getElementById("pnlVerticalHsbSaturation_Hue")
			);
...
function SetGradientPositionDark()
{
	...
	document.getElementById("pnlGradientPosition").style.backgroundImage = "url(GradientPositionDark.gif)";
}
function SetGradientPositionLight()
{
	if(!GradientPositionDark) return;
	GradientPositionDark = false;
	document.getElementById("pnlGradientPosition").style.backgroundImage = "url(GradientPositionLight.gif)";
}
