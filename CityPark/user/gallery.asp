...
Set MyFolder=MyFileObject.GetFolder(phisicalpath &  Application(ScriptName & "ScriptPath") & "\users\" & Session("UsersID") & "\File\gallery\")
i=0
FOR EACH thing in MyFolder.Files
FileName=thing.Name
image = "/Sites/" &  Application(ScriptName & "ScriptPath") & "/users/" & Session("UsersID") & "/File/gallery/" & FileName %>
<li><a class="thumb" name="leaf" href="<% = image %>" title="Title"><img src="<% = image %>" width="80" alt="" /></a></li>
<%  NEXT %>
    </ul>
</div>
